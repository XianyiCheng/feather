...
async function DELETE(request) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].deleteDraft(accessToken, draftId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
async function POST(request) {
    ...
    try {
        ...
        let draft;
        if (draftId) {
            draft = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].updateDraft(accessToken, draftId, params);
        } else {
            draft = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].createDraft(accessToken, params);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(draft);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__143475b2._.js.map