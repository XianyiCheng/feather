...
"[project]/src/app/api/emails/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const thread = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].getThread(accessToken, id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(thread);
    } catch (error) {
...
async function POST(request, { params }) {
    ...
    try {
        if (action === "archive") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].archiveThread(accessToken, id);
        } else if (action === "markAsRead") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].markThreadAsRead(accessToken, id);
        } else if (action === "markAsUnread") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].markThreadAsUnread(accessToken, id);
        } else if (action === "moveToDone") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].moveToDone(accessToken, id);
        } else if (action === "moveToInbox") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailClient"].moveToInbox(accessToken, id);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06100490._.js.map